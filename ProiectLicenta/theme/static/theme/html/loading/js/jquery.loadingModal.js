(function ($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        this.animations = {
            doubleBounce: {html: '<div class="sk-double-bounce"><div class="sk-child sk-double-bounce1"></div><div class="sk-child sk-double-bounce2"></div><div class="sk-child sk-double-bounce3"></div></div>'},
